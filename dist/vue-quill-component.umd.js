(function (global, factory) {
	...
	(global = global || self, factory(global.VueQuill = {}, global.Quill));
	...
	//
	    ...
	    var script = {
	        ...
	        mounted: function() {
	            ...
	            this.quill.on('editor-change', function (name) {
	                var ref, ref$1;

	                var args = [], len = arguments.length - 1;
	                while ( len-- > 0 ) args[ len ] = arguments[ len + 1 ];
	                if (name === 'text-change') {
	                    (ref = this$1).onEditorTextChange.apply(ref, args);
	                }
	                
	                if (name === 'selection-change') {
	                    (ref$1 = this$1).onEditorSelectionChange.apply(ref$1, args);
	                }
	            });
	        },
	        methods: {
	    ...
	    function isValueEqual(value, previousValue) {
			if (value.ops && previousValue.ops) {
				return lodash_isequal(value.ops, previousValue.ops);
			} else {
				return lodash_isequal(value, nextValue);
			}
		}
	...
	var __vue_render__ = function() {
	  ...
	  return _c("div", { ref: "quillElement" })
	};
	...
	function install(Vue) {
		...
		Vue.component('VueQuill', component);
	}
